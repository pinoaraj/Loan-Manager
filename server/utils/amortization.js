/**
 * Amortization Engine
 * Supports various loan types and payment frequencies.
 */
...
const calculateAmortization = (principal, monthlyRate, durationMonths, startDate, frequency = 'monthly', loanType = 'Fixed') => {
