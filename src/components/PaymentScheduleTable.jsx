                ...
                <table className="w-full text-left text-sm">
                    <thead className="sticky top-0 z-10 bg-slate-50 dark:bg-slate-900">
                        <tr>
                            ...
                            <th className="p-4 font-bold text-slate-600 dark:text-slate-200">Fecha de Vencimiento</th>
                            <th className="p-4 text-right font-bold text-slate-600 dark:text-slate-200">Monto</th>
                            <th className="p-4 text-center font-bold text-slate-600 dark:text-slate-200">Estado</th>
                            <th className="p-4 text-right font-bold text-slate-600 dark:text-slate-200">Accion</th>
                        </tr>
                    </thead>
                                ...
                                <tr className={`transition-colors ${payment.id === focusedPaymentId
                                        ...
                                        <div className="flex items-center gap-2">
                                            {((payment.transactions && payment.transactions.length > 0) || payment.status === 'Partial' || payment.status === 'Paid') && (
                                                <button
                                                    ...
                                                    className="rounded-lg p-1 transition-colors hover:bg-slate-200 dark:hover:bg-slate-600"
                                                >
                                    ...
                                    <td className="p-4 text-center">
                                        <div className="group relative inline-block">
                                            <span className={`cursor-help rounded-lg px-2 py-1 text-[10px] font-black uppercase tracking-tighter ${payment.status === 'Paid' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-200' : payment.status === 'Partial' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-200' : 'bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-200'}`}>
                                    ...
                                    <td className="flex justify-end gap-2 p-4 text-right">
                                        <button
                                            ...
                                            className="rounded-xl border border-slate-200 bg-slate-50 p-2 text-slate-500 shadow-sm transition-all hover:border-green-500 hover:bg-green-50 hover:text-green-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-green-950/30 dark:hover:text-green-300"
                                        ...
                                        {payment.status === 'Paid' && (
                                            <div className="flex items-center gap-1">
                                                <button
                                                    ...
                                                    className="rounded-xl border border-slate-200 bg-slate-50 p-2 text-slate-500 shadow-sm transition-all hover:border-indigo-500 hover:bg-indigo-50 hover:text-indigo-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-indigo-950/30 dark:hover:text-indigo-300"
                                                ...
                                                <button
                                                    ...
                                                    className="rounded-xl border border-slate-200 bg-slate-50 p-2 text-slate-500 shadow-sm transition-all hover:border-blue-500 hover:bg-blue-50 hover:text-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-blue-950/30 dark:hover:text-blue-300"
                                        ...
                                        {payment.status !== 'Paid' && (
                                            <button
                                                ...
                                                className="rounded-xl border border-slate-200 bg-white p-2 text-slate-500 shadow-sm transition-all hover:border-emerald-500 hover:bg-emerald-50 hover:text-emerald-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-emerald-950/30 dark:hover:text-emerald-300"
                                    ...
                                    <tr className="bg-slate-50/30 dark:bg-slate-900/40">
                                        <td colSpan="5" className="p-4 pl-12 shadow-inner">
                                            <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                                                <h5 className="mb-3 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">
                                                    <Clock size={12} />
                                                    Historial de Pagos
                                                </h5>
                                                <table className="w-full text-xs">
                                                    ...
                                                    <tbody className="text-slate-600 dark:text-slate-200">
                                                        {payment.transactions && payment.transactions.length > 0 ? (
                                                            payment.transactions.map((transaction) => (
                                                                <tr key={transaction.id} className="border-b border-slate-50 transition-colors last:border-0 hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-700/40">
                                                            ...
                                                            <tr>
                                                                <td colSpan="5" className="py-4 text-center italic text-slate-500 dark:text-slate-300">
