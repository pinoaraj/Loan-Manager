...
8. `build_icon()` - 7 edges
9. `isValidRut()` - 7 edges
10. `ClientDetail()` - 6 edges
...
- **Why does `formatRutInput()` connect `Community 4` to `Community 3`?**
