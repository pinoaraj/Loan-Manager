...
Cohesion: 0.1
Nodes (15): useLoans(), RecentActivity(), ClientDetail(), Collections(), Dashboard(), ImportData(), Skeleton(), cn() (+7 more)

### Community 1 - "Community 1"
Cohesion: 0.15
Nodes (30): buildMutuoDocument(), buildMutuoParagraphs(), buildMutuoText(), buildPagareIntroParagraphXml(), buildPagareValueParagraphXml(), downloadBlob(), escapeXml(), fetchBinaryTemplate() (+22 more)

### Community 2 - "Community 2"
Cohesion: 0.1
Nodes (14): Footer(), Sidebar(), AuthProvider(), LoanProvider(), ThemeProvider(), useAuth(), useTheme(), useLoanHealth() (+6 more)
...
- **Why does `formatRutInput()` connect `Community 4` to `Community 0`?**
